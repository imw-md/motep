...
from motep.active.algorithms import ExaustiveAlgorithm, MaxVolAlgorithm
from motep.io.mlip.cfg import read_cfg
from motep.io.mlip.mtp import read_mtp


def test_maxvol(data_path: Path) -> None:
    """Test if the MaxVol algorithm gives the same results as the exaustive search."""
    ...
    algo_ref = ExaustiveAlgorithm(images_training, mtp_data, engine="numba", rng=rng)
